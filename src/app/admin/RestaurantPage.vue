          ...
          <div>
            ...
            <template v-if="region === 'JP'">
              ...
              <div class="cols">
                <div class="flex-1">
                  <text-form
                    ...
                    :error="errors['zip']"
                    title-key="shopInfo.zip"
                    placeholder="editRestaurant.enterZip"
                    :maxlength="10"
                  />
                </div>
                <div class="p-l-16">
                  <state v-model="shopInfo.state" :errors="errors" />
                </div>
              </div>
              <!-- City -->
              <text-form
              ...
              <text-form
                ...
                title-key="shopInfo.streetAddress"
      ...
      <div class="column">
        <div class="m-l-24 m-r-24">
          ...
          <div class="m-t-16">
            ...
            <div>
              <phone-entry
                :current-number="shopInfo.phoneNumber"
        ...
        <div class="m-l-24 m-r-24">
          ...
          <div>
            <text-form
              ...
              :required="false"
              :maxlength="300"
              title-key="editRestaurant.introduction"
          ...
          <div>
            <text-form
              ...
              :required="false"
              :maxlength="300"
              title-key="editRestaurant.orderNotice"
          ...
          <div>
            <text-form
              ...
              :required="false"
              :maxlength="300"
              title-key="editRestaurant.orderThanks"
            ...
            <div v-if="requireTaxPriceDisplay" class="m-t-16">
              ...
              >
                ...
                <div class="m-t-8">
                  ...
                  <Price :shop-info="shopInfo" :menu="sampleMenu" />
                </div>
              </div>
            </div>
          </div>
