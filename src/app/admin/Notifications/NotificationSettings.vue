<template>
  ...
  >
    <div class="op-dialog p-t-24 p-l-24 p-r-24 p-b-24">
      ...
      <div>
        <!-- Incomplete Orders -->
        <incomplete-orders v-if="shopInfo" :shop-info="shopInfo" />
        <!-- Settings -->
        <div>
          <div class="t-subtitle2 c-text-black-medium p-b-8 m-t-24">
            {{ $t("admin.order.notificationSettings") }}
          </div>
          <!-- Sound ON/OFF -->
          <div class="is-inline-block m-r-16" @click="soundToggle()">
            <div
          ...
          >
            ...
            <div class="is-inline-block" @click="infinityNotificationToggle()">
              <div
