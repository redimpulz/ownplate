          ...
          <div class="m-l-24 m-r-24">
            ...
            >
              ...
              <div>
                <div class="align-center">
                  <div class="is-inline-flex flex-center">
                    <!-- Order ID -->
                    <div class="t-h4 c-text-black-high">
                      {{ orderName }}
                    </div>
                    ...
                    <div class="m-l-16">
                      ...
                      >
                        ( {{ $t('order.includingTip') }} {{ $n(orderInfo.tip, 'currency') }} )
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div v-if="showTimePicker" class="m-t-8">
                ...
                <b-select v-model="timeOffset" class="m-t-8 align-center">
                  <option
            ...
            <div>
              ...
              <div class="align-center m-t-24">
                ...
                >
                  ...
                  <div class="t-caption c-text-black-medium">
                    {{ timeOfEvents["transaction_complete"] }}
                  </div>
                </b-button>
              </div>
            </div>
